...
It fails after 8 second, if it does not get responses from all servers.
...
This operation fails after 8 second, if it does not get responses from all servers.
